...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	open_file->o_fd->fd_offset += n_bytes;
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	off_t min_file_len = req->req_n + open_file->o_fd->fd_offset;
	if (min_file_len >= open_file->o_file->f_size) {
		open_file->o_file->f_size = min_file_len;
	}
